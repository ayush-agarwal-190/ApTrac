...
export class TrashComponent implements OnInit {
  ...
  constructor(private toastr: ToastrService,private breakpointObserver: BreakpointObserver, private fetch: CardfetchService, private route: Router) { }
  ...
  RecoverDeletedTask(item: any) {
    this.fetch.RecoverDeletedTask(item).subscribe(
      response => {
        console.log(item)
        this.toastr.success("Your task is succesfully recover");
        location.reload();
